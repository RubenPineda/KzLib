...
public:
	 ...
	 */
	static FBox GetShapeAABB(const FVector& Position, const FQuat& Rotation, const FKzShapeInstance& Shape);
	...
	static FBox K2_GetShapeAABB(const FVector Position, const FRotator Rotation, const FKzShapeInstance& Shape);
	 ...
	 */
	static FVector ClosestPointOnShape(const FVector& Position, const FQuat& Rotation, const FKzShapeInstance& Shape, const FVector& Point);
	...
	static FVector K2_ClosestPointOnShape(const FVector Position, const FRotator Rotation, const FKzShapeInstance& Shape, const FVector Point);
	 ...
	 */
	static bool ShapeIntersectsPoint(const FVector& Position, const FQuat& Rotation, const FKzShapeInstance& Shape, const FVector& Point);
	...
	static bool K2_ShapeIntersectsPoint(const FVector Position, const FRotator Rotation, const FKzShapeInstance& Shape, const FVector Point);
	...
	static bool ShapeIntersectsSphere(const FVector& Position, const FQuat& Rotation, const FKzShapeInstance& Shape, const FVector& SphereCenter, float SphereRadius);
	...
	static bool K2_ShapeIntersectsSphere(const FVector Position, const FRotator Rotation, const FKzShapeInstance& Shape, const FVector SphereCenter, float SphereRadius);
	 ...
	 * @return FBox representing the world-space AABB.
	 */
	static FBox GetBoxAABB(const FVector& Center, const FVector& HalfSize, const FQuat& Rotation);
	...
	static FBox K2_GetBoxAABB(const FVector Center, const FVector HalfSize, const FRotator Rotation);
	 ...
	 */
	static FVector ClosestPointOnBox(const FVector& Center, const FVector& HalfSize, const FQuat& Rotation, const FVector& Point);
	...
	static FVector K2_ClosestPointOnBox(const FVector Center, const FVector HalfSize, const FRotator Rotation, const FVector Point);
	 ...
	 */
	static bool BoxIntersectsPoint(const FVector& Center, const FVector& HalfSize, const FQuat& Rotation, const FVector& Point);
	...
	static bool K2_BoxIntersectsPoint(const FVector Center, const FVector HalfSize, const FRotator Rotation, const FVector Point);
	 ...
	 */
	static bool BoxIntersectsSphere(const FVector& Center, const FVector& HalfSize, const FQuat& Rotation, const FVector& SphereCenter, float SphereRadius);
	...
	static bool K2_BoxIntersectsSphere(const FVector Center, const FVector HalfSize, const FRotator Rotation, const FVector SphereCenter, float SphereRadius);
	 ...
	 * @return FBox representing the world-space AABB.
	 */
	static FBox GetCapsuleAABB(const FVector& Center, float Radius, float HalfHeight, const FQuat& Rotation);
	...
	static FBox K2_GetCapsuleAABB(const FVector Center, float Radius, float HalfHeight, const FRotator Rotation);
	 ...
	 */
	static FVector ClosestPointOnCapsule(const FVector& Center, float Radius, float HalfHeight, const FQuat& Rotation, const FVector& Point);
	...
	static FVector K2_ClosestPointOnCapsule(const FVector Center, float Radius, float HalfHeight, const FRotator Rotation, const FVector Point);
	 ...
	 */
	static bool CapsuleIntersectsPoint(const FVector& Center, float Radius, float HalfHeight, const FQuat& Rotation, const FVector& Point);
	...
	static bool K2_CapsuleIntersectsPoint(const FVector Center, float Radius, float HalfHeight, const FRotator Rotation, const FVector Point);
	 ...
	 */
	static bool CapsuleIntersectsSphere(const FVector& Center, float Radius, float HalfHeight, const FQuat& Rotation, const FVector& SphereCenter, float SphereRadius);
	...
	static bool K2_CapsuleIntersectsSphere(const FVector Center, float Radius, float HalfHeight, const FRotator Rotation, const FVector SphereCenter, float SphereRadius);
	 ...
	 * @return FBox representing the world-space AABB.
	 */
	static FBox GetCylinderAABB(const FVector& Center, float Radius, float HalfHeight, const FQuat& Rotation);
	...
	static FBox K2_GetCylinderAABB(const FVector Center, float Radius, float HalfHeight, const FRotator Rotation);
	 ...
	 */
	static FVector ClosestPointOnCylinder(const FVector& Center, float Radius, float HalfHeight, const FQuat& Rotation, const FVector& Point);
	...
	static FVector K2_ClosestPointOnCylinder(const FVector Center, float Radius, float HalfHeight, const FRotator Rotation, const FVector Point);
	 ...
	 */
	static bool CylinderIntersectsPoint(const FVector& Center, float Radius, float HalfHeight, const FQuat& Rotation, const FVector& Point);
	...
	static bool K2_CylinderIntersectsPoint(const FVector Center, float Radius, float HalfHeight, const FRotator Rotation, FVector Point);
	 ...
	 */
	static bool CylinderIntersectsSphere(const FVector& Center, float Radius, float HalfHeight, const FQuat& Rotation, const FVector& SphereCenter, float SphereRadius);
	...
	static bool K2_CylinderIntersectsSphere(const FVector Center, float Radius, float HalfHeight, const FRotator Rotation, const FVector SphereCenter, float SphereRadius);
};